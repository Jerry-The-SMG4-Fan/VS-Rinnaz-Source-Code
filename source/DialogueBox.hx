...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		else if (PlayState.SONG.song.toLowerCase() == 'misunderstanding')
		{
			portraitLeft = new FlxSprite(-1500, 40);
			portraitLeft.frames = Paths.getSparrowAtlas('portraits/RinnazPortrait');
			portraitLeft.animation.addByPrefix('enter', 'Rinnaz Portrait Enter instance 1', 24, false);
		...
		if (PlayerSettings.player1.controls.ACCEPT && dialogueStarted == true)
		{
			...
			if (dialogueList[1] == null && dialogueList[0] != null)
			{
				if (!isEnding)
				{
					...
					if (PlayState.SONG.song.toLowerCase() == 'senpai' || PlayState.SONG.song.toLowerCase() == 'thorns' || PlayState.SONG.song.toLowerCase() == 'misunderstanding')
