	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'misunderstanding':
				dialogue = CoolUtil.coolTextFile(Paths.txt('misunderstanding/misunderstandingDialogue'));
		}
		...
		switch(stageCheck)
		{
			case 'park':
			{
				curStage = 'park';
				defaultCamZoom = 0.75;
				var bg:FlxSprite = new FlxSprite(-700, -150).loadGraphic(Paths.image('is-this-reggie-NO!/Park'));
				add(bg);
